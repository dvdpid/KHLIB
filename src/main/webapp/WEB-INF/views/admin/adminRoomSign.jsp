...
<body>
 ...
 <c:import url="../common/menubar.jsp"></c:import>
	...
	<div class="mainArea">
		<div class="popup">
			<div id="title"><h1>열람실 관리</h1></div>
			<form action="cancelRoom.ad" method="post">
				<div class="form">
					<table class="formTable">
						...
						<tbody>
							<tr>
								<td style="font-weight: 600; text-align: left;">선택 좌석</td>
							...
							<tr>
								<td style="font-weight: 600; text-align: left;">사용자 이름</td>
								<td style="text-align: right;">
					...
					<div id="btnArea">
						<input type="submit" class="btnArea" value="퇴실 처리">
