...
<c:import url="../common/menubar.jsp"></c:import>
    ...
    <div class="main">
      ...
      <div class="answer" style="white-space: pre-wrap; display: none">
        ...
        예약도서 신청 후 취소 및 변경은 자제 부탁드립니다. ※ ○ 도서 예약 방법을
        모르겠습니다 ☞ 도서관 홈페이지 로그인 후 원하는 도서를 검색하신 후, 도서
        정보 하단 ‘도서 예약 신청’ 버튼 클릭 ○ 도서 예약 시간인데 예약이 안
        됩니다. ☞ 신청자가 많아 제공할 수 있는 예약자 수를 초과한 경우 조기
        마감될 수 있습니다. 이 경우, 도서관 소식(공지사항)을 통하여 안내드리고
        있으니 이 점 참고 바랍니다. ○ 예약 도서 수령 시간은 어떻게 되나요? ☞
        신청하신 날 다음날에 수령 가능하십니다. (단, 토요일 신청분은 화요일
        수령/ 당일 수령 불가능) 예약하신 도서가 승인되면 배정 시간을 문자
        메시지로 보내드리니, 꼭 문자메시지를 확인하신 후 방문 부탁드립니다.
        ...
        있습니다. ○ 예약을 했으나 수령하러 가지 못했습니다. ☞ 수령일 당일에
        ...
        제공하지 않습니다.(4.1.신청부터) ○ 예약한 도서는 어디서 수령할 수
        있나요? ☞ 도서관 지상1층 주차장에 위치한 예약도서 수령처에서 수령
        가능합니다. ○ 대출처리가 이미 되어있는데 수령 안내 문자메시지가 안 와요
      ...
      <div class="clickme">
        <span class="qHead">Q</span> 보존서고도서 어떻게 이용하나요?
      </div>
      <div class="answer" style="white-space: pre-wrap; display: none">
        ■ 보존서고 자료는? 도서관 자료실 공간 부족으로 이용 빈도가 낮거나
        발행년이 오래된 자료는 보존서고에 보관하고 있으며 자료검색 시 소장처가
        ‘보존서고’인 경우 홈페이지에서 자료신청 후 이용하실 수 있습니다. ■ 신청
        및 이용방법 ○ 홈페이지 로그인 ○ 검색 후 보존서고도서 자료 신청 ○
        준비되면 도착 알림 SMS 통보 ○ 수신 후 자료실 방문하여 데스크에서
        ...
        (기한 경과시 자동 취소) ■ 이용시간 □ 도서관별 보존서고 도서 : 평일 4회,
        ...
        가능합니다. ■ 유의사항 · 1인 신청 가능한 권수는 2권입니다. · 알림 통보
        후 기한 내에 이용하지 않을 경우에는 신청이 취소되며, 2회 누적시 이용이
        제한됩니다. · 보존서고 신청자료는 데스크에서만 대출·반납이 가능합니다.
      </div>
      <div class="clickme">
        <span class="qHead">Q</span> DVD는 어떻게 이용하나요?
      </div>
      <div class="answer" style="white-space: pre-wrap; display: none;">
        KH 도서관은 2019. 9월부터 비도서 관외대출을 시행합니다. 대출자격 : KH
      ...
      <div class="clickme">
        <span class="qHead">Q</span> 도서관무료 와이파이는 어떻게 이용하나요?
      </div>
      <div class="answer" style="white-space: pre-wrap; display: none">
      ...
      <div class="clickme">
        <span class="qHead">Q</span> 대출 권수와 대출기간은 어떻게 되나요?
      </div>
      <div class="answer" style="white-space: pre-wrap; display: none">
